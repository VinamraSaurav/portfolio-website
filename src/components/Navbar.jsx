  ...
  return (
    <div className="m-0">
      <div className="max-w-7xl mx-auto fixed top-0 right-0 left-0 xls:block backdrop-blur-[21px] h-20 my-auto z-50">
        ...
        <Link href="/"><div className="text-lg xls:text-xl font-popins font-[1000] stroke-2 stroke-black " onClick={handleClickClose}>
            VINAMRA SAURAV
          </div></Link>
          <div className="xls:flex font-popins text-lg px-3 py-2 mx-2 gap-7 font-bold transition-all duration-300 hidden">
            <Link href="/">
              <div  onClick={handleClickClose} className="flex gap-2 items-center hover:text-color-5 hover:bg-color-1 py-1 px-2 rounded-md hover:cursor-pointer transition-all duration-300">
                <MdHome className="text-2xl" /> HOME
              </div>
            </Link>
            <Link href="/projects">
              <div  onClick={handleClickClose} className="flex gap-2 items-center hover:text-color-5 hover:bg-color-1 py-1 px-2 rounded-md hover:cursor-pointer transition-all duration-300">
                <GoProjectSymlink className="text-2xl" /> PROJECTS
              </div>
            </Link>
            ...
            <Link href="/education">
              <div  onClick={handleClickClose} className="flex gap-1 items-center hover:text-color-5 hover:bg-color-1 py-1 px-2 rounded-md hover:cursor-pointer transition-all duration-300">
      ...
      <div
        className={`z-50 xls:hidden px-3 py-2 font-bold  fixed bg-white/90 h-screen top-20 w-7/12 flex items-center transition-all duration-300 ease-in-out justify-center ${
          open ? "right-0" : "right-[-910px]"
        }`}
      >
        <div className="flex flex-col gap-y-7 text-lg font-popins transition-all duration-300 items-start">
          <Link href="/">
            {" "}
            <div  onClick={handleClickClose} className="flex gap-2 items-center hover:text-color-5 hover:bg-color-1 py-1 px-3 rounded-md hover:cursor-pointer transition-all duration-300">
              <MdHome className="text-2xl" /> HOME
            </div>
          </Link>
          <div className="flex items-center mx-auto h-[0.9px] w-9/12 bg-black"></div>
          <Link href="/projects">
            <div  onClick={handleClickClose} className="flex gap-2 items-center hover:text-color-5 hover:bg-color-1 py-1 px-3 rounded-md hover:cursor-pointer transition-all duration-300">
              <GoProjectSymlink className="text-2xl" /> PROJECTS
            </div>
          </Link>
          <div  className="flex items-center mx-auto h-[0.8px] w-9/12 bg-black"></div>
          <Link href="/experience">
            {" "}
            <div  onClick={handleClickClose} className="flex gap-2 items-center hover:text-color-5 hover:bg-color-1 py-1 px-3 rounded-md hover:cursor-pointer transition-all duration-300">
              <MdOutlineWork className="text-2xl" /> EXPERIENCE
          ...
          <div className="flex items-center mx-auto h-[0.91px] w-9/12 bg-black"></div>
          <Link href="/education">
            <div  onClick={handleClickClose} className="flex gap-1 items-center hover:text-color-5 hover:bg-color-1 py-1 px-3 rounded-md hover:cursor-pointer transition-all duration-300">
              <FaGraduationCap className="text-2xl" /> EDUCATION
            </div>
          </Link>
        </div>
